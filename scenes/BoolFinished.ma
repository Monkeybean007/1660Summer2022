...
//Name: BoolFinished.ma
//Last modified: Thu, Jul 14, 2022 04:56:15 PM
//Codeset: 1252
requires maya "2023";
requires "mtoa" "5.1.0";
requires "mtoa" "4.0.3";
...
fileInfo "UUID" "00EA581A-4BF9-866C-C493-36918A4C538A";
createNode transform -s -n "persp";
	rename -uid "2F96C5CC-CF48-3364-978F-BF80661D753F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 15.081773785651855 8.5854384924864071 7.1779132701768562 ;
	setAttr ".r" -type "double3" -17.95721674719158 67.129171569041048 8.1834933359352366e-15 ;
	setAttr ".rp" -type "double3" 7.7715611723760958e-16 3.1086244689504383e-15 -3.5527136788005009e-15 ;
	setAttr ".rpt" -type "double3" -4.5696100795518715e-15 -1.2939102531187372e-15 1.0787990020719608e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "F7E47E0A-8A46-F757-7132-5EBE985BE8D9";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999979;
	setAttr ".coi" 18.510948373885423;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -1.1430734256467012 2.8783882305108408 0.33400210930156504 ;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "8785F315-403D-7FBC-9A92-87A8CF9EDD1C";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "C41730EA-442F-B6F4-86D4-72BDDEA83B7A";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "6515B118-488A-3B44-EDFD-7BB7A9EAA06E";
createNode displayLayerManager -n "layerManager";
	rename -uid "A73025AE-473D-FC0D-7C76-F681B34747FB";
createNode displayLayer -n "defaultLayer";
	rename -uid "0414B539-DB48-25FD-A367-6388F5147D34";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "9EBC1637-43E9-2E25-E611-D4940B071A23";
...
createNode polyTriangulate -n "polyTriangulate1";
	rename -uid "CAE72B35-48A2-4B71-9543-C4842D883472";
	setAttr ".ics" -type "componentList" 3 "f[120]" "f[302]" "f[364:369]";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
connectAttr "polyTriangulate1.out" "pSphere2Shape.i";
